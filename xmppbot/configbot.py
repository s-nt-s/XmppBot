...
class Avatar:
    ...
    def init(cls, file:str):
        ...
        try:
            ...
            logger.warn("avatar can't load because of file %s does not exist" % file)
        except IOError:
            logger.warn("avatar can't load because of file %s cant't be read" % file)
        return None
...
class ConfigBot:
    ...
    def __init__(self, user:str, password:str, vcard:dict=None, avatar:str=None, roster:str|list[str]=None, rooms:str|list[str]=None, plugins:str|list[str]=DEFAULT_PLUGINS, lisent:str|list[str]=DEFAULT_LISENT, to:str|list[str]=None, friendly:bool=False, use_ipv6:bool=True, img_to_oob:bool=False):
        self.user = user
